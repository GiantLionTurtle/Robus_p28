...
const mt::Box zones_boxes[n_zones] {
	mt::Box{ .bottomLeft=mt::Vec2(0.0, 6*Foot), 		.topRight=mt::Vec2(4*Foot, 12*Foot) }, // 0
	...
	mt::Box{ .bottomLeft=zone9_bottomLeft, 			.topRight=mt::Vec2(4*Foot, 6*Foot)}, // 9
	mt::Box{ .bottomLeft=mt::Vec2(1.22, 1.23), 	.topRight=mt::Vec2(1.82, 2.44)} // shortcut
};
