...
#else
constexpr double kRobotWidth = 0.1855;              // m
#endif
...
constexpr double kRealignSpeed = kMinSpeed;
constexpr double kInertiaForwardDist = 0.05;
constexpr double kInertiaDist = 0.04;
